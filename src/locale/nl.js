export default {
    functionlist:[{
        ...
        "a": "Multinomiale verdelingsfunctie.",
        "m": [1, 255],
        "p": [{
            "name": "waarde1",
            "detail": "De eerste waarde of het eerste bereik om te overwegen.",
            "example": "1",
            "require": "m",
            "repeat": "n",
            "type": "rangeall"
            ...
            "name": "waarde2",
            "detail": "Aanvullende waarden of bereiken om te overwegen.",
            "example": "2",
            "require": "o",
            "repeat": "y",
            "type": "rangeall"
        ...
        "n": "ATANH",
        "t": 0,
        "d": "Retourneert de inverse hyperbolische tangens van een getal.",
        "a": "Inverse hyperbolische tangens van een getal.",
        "m": [1, 1],
        "p": [{
            "name": "waarde",
            "detail": "De waarde waarvoor de inverse hyperbolische tangens moet worden berekend. Moet tussen -1 en 1 zijn, exclusief.",
            "example": "0.9",
            "require": "m",
            "repeat": "n",
            "type": "rangenumber"
        ...
        "n": "ATAN2",
        "t": 0,
        "d": "Retourneert de hoek tussen de x-as en een lijnsegment van de oorsprong (0,0) naar het gespecificeerde coördinatenpaar (`x`,`y`), in radialen.",
        "a": "Arctangens van een waarde.",
        "m": [2, 2],
        "p": [{
            "name": "x",
            "detail": "De x-coördinaat van het eindpunt van het lijnsegment waarvoor de hoek vanaf de x-as moet worden berekend.",
            "example": "4",
            "require": "m",
            "repeat": "n",
            "type": "rangenumber"
            ...
            "name": "y",
            "detail": "De y-coördinaat van het eindpunt van het lijnsegment waarvoor de hoek vanaf de x-as moet worden berekend.",
            "example": "3",
            "require": "m",
            "repeat": "n",
            "type": "rangenumber"
        ...
        "p": [{
            "name": "waarde1",
            "detail": "Het eerste getal of bereik dat moet worden opgeteld.",
            "example": "A2:A100",
            "require": "m",
            "repeat": "n",
            "type": "rangeall"
    ...
    toolbar: {
        ...
        currencyFormat: 'Opmaken als valuta',
        ...
        strikethrough: 'Doorhalen (Alt+Shift+5)',
        underline: 'Onderstrepen',
        textColor: 'Text kleur',
        chooseColor: 'Kies kleur',
        resetColor: 'Resetten',
        customColor: 'Aangepast',
        alternatingColors: 'Afwisselende kleuren',
        confirmColor: 'OK',
        cancelColor: 'Annuleren',
        collapse: 'Samenvouwen',
        fillColor: 'Opvulkleur',
        border: 'Rand',
        borderStyle: 'Rand stijl',
        mergeCell: 'Cellen samenvoegen',
        chooseMergeType: 'Kies samenvoegtype',
        horizontalAlign: 'Horizontaal uitlijnen',
        verticalAlign: 'Verticaal uitlijnen',
        alignment: 'Uitlijning',
        textWrap: 'Tekstomloop',
        textWrapMode: 'Tekstterugloopmodus',
        textRotate: 'Tekst roteren',
        textRotateMode: 'Tekstrotatiemodus',
        freezeTopRow: 'Eerste rij vastzetten',
        sortAndFilter: 'Sorteren en filteren',
        findAndReplace: 'Zoek en vervang',
        sum: 'SUM',
        autoSum: 'Auto SUM',
        moreFunction: 'Meer functies',
        conditionalFormat: 'Conditionele opmaak',
        postil: 'Commentaar',
        pivotTable: 'Draaitabel',
        chart: 'Grafiek',
        screenshot: 'Schermafbeelding',
        splitColumn: 'Tekst splitsen',
        insertImage: 'Voeg afbeelding in',
        insertLink: 'Link invoegen',
        dataVerification: 'Gegevensverificatie',
        protection:"Bescherm het blad",
        ...
        toolLess:"Minder",
        toolClose:"Sluiten",
        toolMoreTip:"Meer eigenschappen",
        moreOptions:"Meer opties",

        cellFormat:"Cell formattering configuratie",
        print:"Printen",
    },
    alternatingColors:{
    ...
    format:{
        moreCurrency: 'Meer valuta-indelingen',
        moreDateTime: 'Meer datum- en tijdnotaties',
        moreNumber: 'Meer getalnotaties',

        titleCurrency: 'Valuta-indelingen',
        decimalPlaces: 'decimalen',
        titleDateTime: 'Datum- en tijdnotaties',
        titleNumber: 'Getalnotaties'
    },
    info:{
    ...
    defaultFmt:[
        ...
        { "text": 'Getal', "value": "##0.00", "example": "1000.12" },
    ...
    border:{
        borderTop:'Bovenrand',
        borderBottom:'Onderrand',
        borderLeft:'Linkerrand',
        borderRight:'Rechterrand',
    ...
    rightclick: {
        ...
        hide: 'Verbergen',
        hideSelected: 'Verberg geselecteerde ',
        showHide: 'Toon verborgen ',
        to: 'Richting',
        left: 'Links',
        right: 'Rechts',
        top: 'Bovenkant',
        ...
        number: 'Getal',
        confirm: 'Bevestigen',
        orderAZ: 'A-Z volgorde',
        orderZA: 'Z-A volgorde',
        clearContent: 'Inhoud wissen',
        matrix: 'Matrixbewerking',
        sortSelection: 'Sorteren',
        filterSelection: 'Filteren',
        chartGeneration: 'Grafiek maken',
        firstLineTitle: 'titel eerste regel',
        untitled: 'ongetiteld',
        array1: 'Eendimensionale matrix',
        array2: 'Tweedimensionale matrix',
        array3: 'Multidimensionale arrays',
        diagonal: 'Diagonaal',
        antiDiagonal: 'Anti-diagonaal',
        diagonalOffset: 'Diagonale offset',
        offset: 'Offset',
        boolean: 'Boolean',
        flip: 'Flip',
        upAndDown: 'Omhoog en omlaag',
        leftAndRight: 'Links en rechts',
        clockwise: 'Met de klok mee',
        counterclockwise: 'Tegen de klok in',
        transpose: 'Transponeren',
        matrixCalculation: 'Matrixberekening',
        plus: 'Plus',
        minus: 'Min',
        ...
        root: 'Wortel',
        log: 'Log',
        delete0: 'Verwijder 0 waarden aan beide uiteinden',
        removeDuplicate: 'Dubbele waarden verwijderen',
        byRow: 'Per rij',
        byCol: 'Per kolom',
        generateNewMatrix: 'Genereer nieuwe matrix',
    ...
    findAndReplace:{
        ...
        condition:"Conditie",
        rowSpan:"Rij bereik",
        columnSpan:"Kolom bereik",
        locationExample:"Locatie",
        lessTwoRowTip:"Selecteer ten minste twee rijen",
        lessTwoColumnTip:"Selecteer ten minste twee kolommen",

        findTextbox:"Inhoud zoeken",
        replaceTextbox:"Inhoud vervangen",

        regexTextbox:"Regular Expression",
        wholeTextbox:"Heel woord",
        distinguishTextbox:"Hoofdlettergevoelig",

        allReplaceBtn:"Vervang alles",
        replaceBtn:"Vervangen",
        allFindBtn:"Vind alle",
        findBtn:"Volgende zoeken",

        noFindTip:"De inhoud is niet gevonden",
        modeTip:"Deze bewerking is niet beschikbaar in deze modus",
    ...
    insertLink: {
        ...
        linkSheet: "Worksheet",
        linkCell: "Celverwijzing",
        linkTooltip: "Info",
        placeholder1: "Voer het weblinkadres in",
        placeholder2: "Voer de cel in die moet worden geciteerd, voorbeeld A1",
        placeholder3: "Voer de inhoud van de prompt in",
        tooltipInfo1: "Voer een geldige link in",
        tooltipInfo2: "Voer de juiste celverwijzing in",
    },
    dataVerification: {
    ...
    formulaMore:{
        valueTitle:"Waarde",
        tipSelectDataRange:"Selecteer gegevensbereik",
        tipDataRangeTile:"Data bereik",
        findFunctionTitle:"Zoekfunctie",
        tipInputFunctionName:"Functienaam of korte beschrijving van functie",
    ...
    drag:{
        ...
        pasteMustKeybordAlert:"Kopieer en plak in een tabel: Ctrl + C Kopiëren, Ctrl + V Plakken, Ctrl + X Knippen",
        pasteMustKeybordAlertHTMLTitle:"Kopieer en plak in een tabel",
        pasteMustKeybordAlertHTML:"<span style='line-height: 1.0;font-size:36px;font-weight: bold;color:#666;'>Ctrl + C</span>&nbsp;&nbsp;een kopie maken<br/><span style='line-height: 1.0;font-size:36px;font-weight: bold;color:#666;'>Ctrl + V</span>&nbsp;&nbsp;plakken<br/><span style='line-height: 1.0;font-size:36px;font-weight: bold;color:#666;'>Ctrl + X</span>&nbsp;&nbsp;knippen",
    },
    pivotTable:{
        title:"Pivot Table",
        closePannel:"Close",
        ...
        errorSelectRange:"Selecteer het bereik van de nieuwe draaitabel",
    ...
    websocket:{
        ...
        contact: 'Er is een servercommunicatiefout opgetreden, ververs de pagina en probeer het opnieuw, zo niet, neem dan contact op met de beheerder!',
        support: 'De huidige browser ondersteunt WebSocket niet',
    }
  };
